...
import { UserCheck, Search, CheckCircle, Shield } from "lucide-react";

export default function GuideDirectory({ guides = [] }) {
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-[#65736D] text-xs mt-0.5 font-medium">
            Active volunteer legal advisors in local jurisdiction ({guides.length} total)
          </p>
        </div>
