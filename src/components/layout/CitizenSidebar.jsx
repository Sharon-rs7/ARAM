  ...
  return (
    <aside className="flex min-h-screen w-[260px] flex-col bg-[#0B1F36] text-white">
      ...
      <div className="border-b border-white/10 p-8">
        <h1 className="text-3xl font-bold text-blue-400">ARAM</h1>
        <p className="mt-2 text-xs text-slate-400">Citizen Panel</p>
      </div>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 rounded-xl px-3 py-2.5 transition-colors ${
                    isActive
                      ? "bg-blue-650/20 text-white ring-1 ring-blue-400/20 font-medium"
