...
const Button = ({
  ...
  const variants = {
    ...
    ghost: "text-slate-650 hover:bg-slate-100 hover:text-slate-900 focus:ring-slate-200 px-3",
    success: "bg-green-700 text-white shadow-sm hover:bg-green-800 focus:ring-green-200",
    danger: "bg-red-650 text-white shadow-sm hover:bg-red-750 focus:ring-red-250",
