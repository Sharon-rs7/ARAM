    ...
    <section className="bg-[#FFFDF8] py-20 border-t border-[#E6E1D8]">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="rounded-3xl bg-[#163D32] p-8 text-white space-y-4 shadow-lg">
          <h3 className="text-lg font-bold text-[#DCEBDD]">{t("about.commitmentsTitle", "ARAM Core Commitments")}</h3>
          <div className="space-y-3 text-xs text-white/90">
            <p>✓ {t("about.c1", "Zero Hallucination: All legal advice is verified against certified statutes.")}</p>
            <p>✓ {t("about.c2", "Privacy Protection: Automatic PII masking of Aadhaar and personal details.")}</p>
            <p>✓ {t("about.c3", "Official Email Gateway: Centralized communication from ouraramsupport@gmail.com.")}</p>
          </div>
        </div>
      </div>
    </section>
