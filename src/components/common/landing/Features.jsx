...
const Features = () => {
  ...
  const features = [
    {
      icon: Sparkles,
      title: t("features.f1Title", "11-Part Structured Legal Triage"),
      desc: t("features.f1Desc", "Every query receives grounded statutory citation, section applicability, next steps, document checklists, and DLSA authority routing."),
      color: "bg-[#DCEBDD] text-[#163D32]"
    },
    {
      icon: Mic,
      title: t("features.f2Title", "Multilingual Voice Assistant"),
      desc: t("features.f2Desc", "Direct voice input in Tamil (தமிழ்), Hindi (हिंदी), and English for hands-free grievance registration and guidance."),
      color: "bg-[#F6D8C8] text-[#8C3B1E]"
    },
    {
      icon: FileCheck,
      title: t("features.f3Title", "OCR Document Readiness Checker"),
      desc: t("features.f3Desc", "Automated optical character verification of sale deeds, partition agreements, and notices with legal readiness scoring."),
      color: "bg-[#E8C978]/50 text-[#7A5A0A]"
    },
    {
      icon: Users,
      title: t("features.f4Title", "Certified Legal Guide Workflow"),
      desc: t("features.f4Desc", "Seamless escalation from AI triage to verified local paralegal guides and District Legal Services Authorities (DLSA)."),
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-14 space-y-2">
          ...
          <p className="text-xs sm:text-sm text-[#65736D]">
            {t("features.subtitle", "Strictly grounded against certified Indian law provisions with zero synthetic hallucination.")}
          </p>
        </div>
