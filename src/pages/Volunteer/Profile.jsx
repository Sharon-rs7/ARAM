    ...
    const fetchProfile = async () => {
      try {
        ...
        setProfile({
          ...
          reasonToVolunteer: data.reasonToVolunteer || "Passionate about legal aid accessibility."
        });
      } catch (err) {
        if (authUser) {
          setProfile({
            ...
            reasonToVolunteer: authUser.reasonToVolunteer || "Passionate about legal aid accessibility."
          });
        }
      }
    };
    ...
    <DashboardLayout>
      <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-4xl font-bold text-slate-900">Volunteer Profile</h1>
            <p className="mt-2 text-slate-500">Manage your volunteer information.</p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 shadow-sm">
          <div className="flex flex-col items-center gap-8 lg:flex-row">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-3xl font-bold text-slate-900">{profile.name || "Sharon Mary"}</h2>
              <p className="mt-2 text-slate-500">Legal Volunteer Assistant</p>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className="w-full h-12 rounded-xl border border-slate-200 px-4 outline-none disabled:bg-slate-50 disabled:text-slate-550 transition focus:border-blue-500 focus:ring-4"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={!isEditing}
                    className="w-full h-12 rounded-xl border border-slate-200 pl-12 pr-4 outline-none disabled:bg-slate-50 disabled:text-slate-550 transition focus:border-blue-500 focus:ring-4"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  disabled={!isEditing}
                  rows={2}
                  className="w-full rounded-xl border border-slate-200 p-3 outline-none disabled:bg-slate-50 disabled:text-slate-550 transition focus:border-blue-500 focus:ring-4"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  disabled={!isEditing}
                  className="w-full h-12 rounded-xl border border-slate-200 px-3 outline-none disabled:bg-slate-50 disabled:text-slate-550 transition focus:border-blue-500 focus:ring-4"
                >
          ...
          {/* Volunteer Stats */}
          <div className="rounded-3xl bg-white p-8 shadow-sm">
            <h2 className="mb-6 text-2xl font-bold text-slate-900">Volunteer Statistics</h2>
            ...
            <h2 className="my-6 text-2xl font-bold text-slate-900">Specialization</h2>
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-semibold text-slate-550 mb-1.5 uppercase">Law Practice Focus</label>
                <input
                  type="text"
                  value={profile.specialization}
                  onChange={(e) => setProfile(prev => ({ ...prev, specialization: e.target.value }))}
                  disabled={!isEditing}
                  className="w-full h-12 rounded-xl border border-slate-200 px-4 outline-none disabled:bg-slate-50 disabled:text-slate-550 focus:border-blue-500"
                />
              </div>

              <div>
                <label className="block text-xs font-semibold text-slate-550 mb-1.5 uppercase">Jurisdiction Area</label>
                <input
                  type="text"
