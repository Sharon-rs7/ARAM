...
public class CaseCommunicationController {
    ...
    @GetMapping("/admin/complaints/{complaintId}/recommended-guides")
    ...
    // Messages Get
    @GetMapping("/cases/{complaintId}/messages")
    ...
    // Messages Post
    @PostMapping("/cases/{complaintId}/messages")
    ...
    // Escalate Case
    @PostMapping("/volunteer/cases/{complaintId}/escalate")
