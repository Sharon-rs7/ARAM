...
public class AppUser {
    ...
    @Column(name = "associated_authority_id")
    private Long associatedAuthorityId;
    ...
    public Long getAssociatedAuthorityId() { return associatedAuthorityId; }
    public void setAssociatedAuthorityId(Long associatedAuthorityId) { this.associatedAuthorityId = associatedAuthorityId; }
