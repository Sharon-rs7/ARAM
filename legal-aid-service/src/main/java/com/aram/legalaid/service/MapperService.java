...
public class MapperService {
    ...
    public ComplaintResponse toComplaintResponse(Complaint complaint, AIResult aiResult) {
        ...
        Long userId = complaint.getUserId() != null ? complaint.getUserId() : (complaint.getUser() != null ? complaint.getUser().getId() : null);
        String userName = complaint.getUser() != null ? complaint.getUser().getName() : ("Citizen " + userId);
        String formattedComplaintId = complaint.getId() != null ? String.format("CMP-2026-%06d", complaint.getId()) : null;
        String formattedCitizenId = userId != null ? String.format("CIT-2026-%06d", userId) : null;
        return new ComplaintResponse(
                complaint.getId(), userId, userName, complaint.getTitle(),
                ...
                formattedComplaintId, formattedCitizenId,
                complaint.getCitizenOpinion(), complaint.getAdditionalDetails()
        );
    }
