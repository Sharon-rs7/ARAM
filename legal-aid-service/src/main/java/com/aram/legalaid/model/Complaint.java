...
public class Complaint {
    ...
    @Column(name = "referred_advocate_id")
    private Long referredAdvocateId;
    ...
    @Column(length = 20)
    private String submissionMode = "SIMPLE";
    ...
    public Long getAssignedHelperId() { return assignedHelperId; }
    public void setAssignedHelperId(Long assignedHelperId) { this.assignedHelperId = assignedHelperId; }

    public User getUser() {
        if (this.user == null && this.userId != null) {
            this.user = new User();
            this.user.setId(this.userId);
            this.user.setName("Citizen " + this.userId);
            this.user.setEmail("citizen" + this.userId + "@aram.ai");
        }
        return user;
    }
    ...
    public User getAssignedHelper() {
        if (this.assignedHelper == null && this.assignedHelperId != null) {
            this.assignedHelper = new User();
            this.assignedHelper.setId(this.assignedHelperId);
            this.assignedHelper.setName("Helper " + this.assignedHelperId);
            this.assignedHelper.setEmail("volunteer" + this.assignedHelperId + "@aram.ai");
        }
    ...
    public void setAssignedHelper(User assignedHelper) {
        ...
        if (assignedHelper != null) {
            this.assignedHelperId = assignedHelper.getId();
        }
    }
    ...
    public Long getReferredAdvocateId() { return referredAdvocateId; }
    public void setReferredAdvocateId(Long referredAdvocateId) { this.referredAdvocateId = referredAdvocateId; }

    public User getReferredAdvocate() {
        if (this.referredAdvocate == null && this.referredAdvocateId != null) {
            this.referredAdvocate = new User();
            this.referredAdvocate.setId(this.referredAdvocateId);
            this.referredAdvocate.setName("Advocate " + this.referredAdvocateId);
            this.referredAdvocate.setEmail("advocate" + this.referredAdvocateId + "@aram.ai");
        }
        return referredAdvocate;
    }
    public void setReferredAdvocate(User referredAdvocate) {
        this.referredAdvocate = referredAdvocate;
        if (referredAdvocate != null) {
            this.referredAdvocateId = referredAdvocate.getId();
        }
    }
    ...
    public String getCitizenOpinion() { return citizenOpinion; }
    public void setCitizenOpinion(String citizenOpinion) { this.citizenOpinion = citizenOpinion; }
